#ifndef _NGX_HTTP_AKAMAI_TOKEN_MPD_H_INCLUDED_
#define _NGX_HTTP_AKAMAI_TOKEN_MPD_H_INCLUDED_
...
} ngx_http_akamai_token_mpd_ctx_t;
...
#endif // _NGX_HTTP_AKAMAI_TOKEN_MPD_H_INCLUDED_
